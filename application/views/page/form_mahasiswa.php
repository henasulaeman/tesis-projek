              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="<?php echo base_url() ?>Mahasiswa/proses_insert_mahasiswa" method="POST">
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="npm" class="form-control" id="basic-icon-default-fullname" placeholder="NPM Mahasiswa" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                       <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="nama_mhs" class="form-control" id="basic-icon-default-fullname" placeholder="Nama Mahasiswa" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="email_mhs" class="form-control" id="basic-icon-default-fullname" placeholder="Email Mahasiswa" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="alamat_mhs" class="form-control" id="basic-icon-default-fullname" placeholder="Alamat Mahasiswa" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="asal_SMA" class="form-control" id="basic-icon-default-fullname" placeholder="Asal SMA" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                       <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="tahun_lulus_SMA" class="form-control" id="basic-icon-default-fullname" placeholder="Tahun Lulus  SMA" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                     <div class="row mb-3">
