              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="<?php echo base_url() ?>Tahun_ajaran/proses_insert_thn_ajar" method="POST">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="thn_ajar" class="form-control" id="basic-icon-default-fullname" placeholder="Tahun ajaran" aria-label="John Doe">
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
