                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" name="kode_matkul" class="form-control" id="basic-icon-default-fullname" value="<?php echo $dt_matkul["kode_matkul"]?>" placeholder="Kode Prodi" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
                       <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-file"></i></span>
                              <input type="text" name="nama_matkul" class="form-control" id="basic-icon-default-fullname" value="<?php echo $dt_matkul["nama_matkul"]?>" placeholder="Kode Prodi" aria-label="John Doe">
                            </div>
                          </div>
                      </div>
