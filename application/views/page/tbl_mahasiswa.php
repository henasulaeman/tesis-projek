<div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data /</span> Mahasiswa</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
              <div class="buy-now">
                  <a href="<?php echo base_url() ?>Mahasiswa/form_insert_mahasiswa" class="btn btn-info btn-buy-now">Tambah Data</a>
                </div>
                  ...
                  <table class="table">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $result->alamat_mhs ?></td>
                        <td><?php if($result->kode_prodi=="TIF"){echo "Teknik Informatika";}elseif($result->kode_prodi=="DKV"){echo "Design Visual Komunikasi";}elseif($result->kode_prodi=="TI"){echo "Teknik Industri";}else{echo "Bisnis Digital";} ?></td>
                        <td>
                        <?php 
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              <a class="dropdown-item" href="<?php echo base_url() ?>Mahasiswa/proses_delete_mahasiswa/<?php echo $result->id_mhs ?>"><i class="bx bx-trash me-1"></i> Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
